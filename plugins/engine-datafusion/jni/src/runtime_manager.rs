...
pub struct RuntimeManager {
    /// Cheap cloneable handle to the IO runtime, used by all JNI entry points.
...
impl RuntimeManager {
    ...
    pub fn shutdown(&self) {
        ...
        // blocks until every datafusion-io-* thread has fully terminated. This makes
        // shutdown observable from tests (no lingering threads after this returns).
